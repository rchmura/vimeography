...
class EDD_SL_Plugin_Updater
{
  ...
  public function __construct($_api_url, $_plugin_file, $_api_data = null)
  {
    ...
    $this->cache_key =
      'edd_sl_' .
      md5(serialize($this->slug . $this->api_data['license'] . $this->beta));
  ...
  public function show_update_notification($file, $plugin)
  {
    ...
    if (
      ...
      if (false === $version_info) {
        ...
        if (
          isset($version_info->contributors) &&
          !is_array($version_info->contributors)
        ) {
          $version_info->contributors = $this->convert_object_to_array(
            $version_info->contributors
          );
        }
  ...
  public function plugins_api_filter($_data, $_action = '', $_args = null)
  {
    ...
    if (isset($_data->contributors) && !is_array($_data->contributors)) {
      $_data->contributors = $this->convert_object_to_array(
        $_data->contributors
      );
    }
  ...
  private function convert_object_to_array($data)
  {
    ...
    foreach ($data as $key => $value) {
      $new_data[$key] = is_object($value)
        ? $this->convert_object_to_array($value)
        : $value;
    }
